	...
	<div class="app-container">
		...
		<el-card shadow="never">
			...
			>
				...
				<el-table-column label="字典类型编码" prop="dictCode" width="200" />
		...
		>
			<dict-data
				v-model:dictCode="selectedDictType.dictCode"
				v-model:dictName="selectedDictType.dictName"
			/>
		</el-dialog>
	</div>
</template>
...
// 当前选中的字典类型
const selectedDictType = reactive({ dictCode: '', dictName: '' });
...
function openDictDialog(row: DictTypePageVO) {
  ...
  selectedDictType.dictCode = row.dictCode;
  selectedDictType.dictName = row.dictName;
}
