	...
	<div class="app-container">
		...
		<el-card shadow="never">
			...
			>
				...
				<el-table-column label="字典名称" prop="itemName" />
				<el-table-column label="字典值" prop="itemValue" />
		...
		>
			<el-form
				...
				label-width="100px"
			>
				<el-form-item label="字典类型">{{ dictName }}</el-form-item>
				<el-form-item label="字典名称" prop="name">
					<el-input v-model="formData.itemName" placeholder="请输入字典名称" />
				</el-form-item>
				<el-form-item label="字典值" prop="value">
					<el-input v-model="formData.itemValue" placeholder="字典值" />
				</el-form-item>
...
function resetForm() {
  ...
  formData.status = 1;
  formData.sort = 1;
  formData.dictCode = props.dictCode;
}
